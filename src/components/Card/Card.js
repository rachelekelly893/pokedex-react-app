	...
	return (
		<div className="Card">
			...
			<div className="Card__img">
				<img src={pokemon.sprites.front_default} alt={pokemon.name} width="150em"/>
			</div>
			...
			<div className="Card__info">
				<Box display="flex" justifyContent="center">
					...
					<DetailsDialog selecetedValue={selectedValue} pokemon={pokemon} open={open} onClose={handleClose} />
				</Box>
			</div>
		</div>
	);
